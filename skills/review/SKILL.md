...
```json
{
  ...
  "modes": {
    ...
    "narrative": {"label": "Narrative", "description": "Waterline-windowed Gemini-synthesized progress narrative — bundles everything since the last waterline, builds the story forward", "file": "modes/narrative.md"},
...
**On "Custom"**: Read ALL 3 named mode files first (`modes/quality.md`, `modes/progress.md`, `modes/narrative.md`), then accept user's framing. Parse into role/goal/mindset.
