...
> - **No Linear MCP? Report and stop.** Headless / no `mcp__linear-server__*` → you cannot navigate; report the skipped reads (which KEYs, and that the MCP was absent) and stop. Never hang, never guess a ticket's contents.
