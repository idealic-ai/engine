# Debug Debriefing (The Diagnostic Report)
**Tags**: #needs-review
**Filename Convention**: `sessions/[YYYY_MM_DD]_[TOPIC]/DEBUG.md`.
...
*Compare the `DEBUG_PLAN.md` to the actual investigation. Where did we pivot?*
