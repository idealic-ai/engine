...
# NOTE: This MUST run before the ~/.claude/* whitelist below. Both match ~/.claude/ paths,
# but hook_allow exits immediately. If the whitelist fires first, directives under
# ~/.claude/ can never be cleared from pendingDirectives (Bug found 2026-02-10).
